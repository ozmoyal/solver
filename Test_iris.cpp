...
TEST_CASE ("Test") {
    RealVariable x;
            ...
            CHECK(((solve((x ^ 2) + 3 * x + 6.0 == 12 + 6.0 * x / 2 - x) == 2) ||
                   (solve((x ^ 2) + 3 * x + 6.0 == 12 + 6.0 * x / 2 - x) == -3)));//16
            CHECK(((solve((x ^ 2) + 2 * x + 5.0 == 27 + 3.0 * x / 2 - x) == 4) ||
                   (solve((x ^ 2) + 2 * x + 5.0 == 27 + 3.0 * x / 2 - x) == -5.5)));//29
            CHECK(((solve((x ^ 2) + 5 * x + 7.0 == 18 + 5.0 * x / 2 - x) == 2) ||
                   (solve((x ^ 2) + 5 * x + 7.0 == 18 + 5.0 * x / 2 - x) == -5.5)));//21
            CHECK(((solve((x ^ 2) + 5 * x + 1.0 == 22 + 4.0 * x / 2 - x) == 3) ||
                   (solve((x ^ 2) + 5 * x + 1.0 == 22 + 4.0 * x / 2 - x) == -7)));//25
            CHECK(((solve((x ^ 2) + 9 * x + 3.0 == 51 + 4.0 * x / 2 - x) == 4) ||
                   (solve((x ^ 2) + 9 * x + 3.0 == 51 + 4.0 * x / 2 - x) == -12)));//55
            CHECK(((solve((x ^ 2) + 1 * x + 1.0 == 1 + 6.0 * x / 2 - x) == 1) ||
                   (solve((x ^ 2) + 1 * x + 1.0 == 1 + 6.0 * x / 2 - x) == 0)));//3
            CHECK(((solve((x ^ 2) + 2 * x + 8.0 == 33 + 6.0 * x / 2 - x) == 5) ||
                   (solve((x ^ 2) + 2 * x + 8.0 == 33 + 6.0 * x / 2 - x) == -5)));//43
            CHECK(((solve((x ^ 2) + 2 * x + 5.0 == 41 + 6.0 * x / 2 - x) == 6) ||
                   (solve((x ^ 2) + 2 * x + 5.0 == 41 + 6.0 * x / 2 - x) == -6)));//53
            CHECK(((solve((x ^ 2) + 2 * x + 10.0 == 16 + 4.0 * x / 2 - x) == 2) ||
                   (solve((x ^ 2) + 2 * x + 10.0 == 16 + 4.0 * x / 2 - x) == -3)));//18

            CHECK(((solve((x ^ 2) + 1 * x + 1.0 == 4 + 0.0 * x / 2 - x) == 1) ||
                   (solve((x ^ 2) + 1 * x + 1.0 == 4 + 0.0 * x / 2 - x) == -3)));//3
            CHECK(((solve((x ^ 2) + 1 * x + 2.0 == 10 + 0.0 * x / 2 - x) == 2) ||
                   (solve((x ^ 2) + 1 * x + 2.0 == 10 + 0.0 * x / 2 - x) == -4)));//8
            CHECK(((solve((x ^ 2) + 3 * x + 3.0 == 24 + 0.0 * x / 2 - x) == 3) ||
                   (solve((x ^ 2) + 3 * x + 3.0 == 24 + 0.0 * x / 2 - x) == -7)));//21
            CHECK(((solve((x ^ 2) + 4 * x + 4.0 == 40 + 0.0 * x / 2 - x) == 4) ||
                   (solve((x ^ 2) + 4 * x + 4.0 == 40 + 0.0 * x / 2 - x) == -9)));//36
            CHECK(((solve((x ^ 2) + 5 * x + 5.0 == 60 + 0.0 * x / 2 - x) == 5) ||
                   (solve((x ^ 2) + 5 * x + 5.0 == 60 + 0.0 * x / 2 - x) == -11)));//55
            CHECK(((solve((x ^ 2) + 6 * x + 6.0 == 84 + 0.0 * x / 2 - x) == 6) ||
                   (solve((x ^ 2) + 6 * x + 6.0 == 84 + 0.0 * x / 2 - x) == -13)));//78
            CHECK(((solve((x ^ 2) + 7 * x + 7.0 == 112 + 0.0 * x / 2 - x) == 7) ||
                   (solve((x ^ 2) + 7 * x + 7.0 == 112 + 0.0 * x / 2 - x) == -15)));//105
            CHECK(((solve((x ^ 2) + 8 * x + 8.0 == 144 + 0.0 * x / 2 - x) == 8) ||
                   (solve((x ^ 2) + 8 * x + 8.0 == 144 + 0.0 * x / 2 - x) == -17)));//136
            CHECK(((solve((x ^ 2) + 9 * x + 9.0 == 180 + 0.0 * x / 2 - x) == 9) ||
                   (solve((x ^ 2) + 9 * x + 9.0 == 180 + 0.0 * x / 2 - x) == -19)));//171
            CHECK(((solve((x ^ 2) + 10 * x + 10.0 == 220 + 0.0 * x / 2 - x) == 10) ||
                   (solve((x ^ 2) + 10 * x + 10.0 == 220 + 0.0 * x / 2 - x) == -21)));//210
